...
public class Transactions {
	...
	public Transactions(int id, String status, String user_session, String user_name, String user_mail,
			String user_phone, String address, String amount, String payment, String message, String created) {
		super();
		this.id = id;
		this.status = status;
